...
# Output: 6
car_number = is_natural('Номер вагона, в который сел Витя: ')
right_car_number = is_natural('В какой вагон он должен был сесть: ')

if car_number == right_car_number:
    print('Количество вагонов невозможно определить')
else:
    result = car_number + right_car_number - 1
